...
const menuCategories = [
    {
        title: "Bakery",
        description: "Homemade cakes, croissants, and pastries inspired by the public profile highlights.",
    ...
    {
        title: "Brunch",
        description: "A la carte brunch plates and relaxed daytime dishes for slow meals and long conversations.",
    ...
    {
        title: "Coffee",
        description: "Coffee service for breakfast, brunch, and evening visits in the Amaradia 73 space.",
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    {menuCategories.map((category, index) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                <p className="text-sm leading-7 text-[#6b7280]">{category.description}</p>
