  ...
  return (
    <footer className="border-t border-[#e5efee] bg-white py-14 text-[#374151]">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 md:grid-cols-3 lg:px-8">
        ...
        <div>
          <h4 className="mb-4 text-lg font-semibold text-[#1f2937]">Navigation</h4>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#6b7280]">
            <li>
              <a href="https://www.instagram.com/turquoise.bakery_brunch/" target="_blank" rel="noreferrer" className="transition hover:text-[#0097a7]">
                Instagram
              </a>
            </li>
            <li>
              <a href="https://www.facebook.com/p/TURQUOISEbakerybrunch-61560796895610/" target="_blank" rel="noreferrer" className="transition hover:text-[#0097a7]">
                Facebook
              </a>
            </li>
          </ul>
      ...
      <div className="mx-auto mt-10 max-w-7xl border-t border-[#eef2f1] px-4 pt-6 text-center text-xs text-[#9ca3af] sm:px-6 lg:px-8">
        © {new Date().getFullYear()} TURQUOISE.bakery&brunch. All rights reserved.
      </div>
    </footer>
  );
}