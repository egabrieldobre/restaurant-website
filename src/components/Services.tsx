...
export default function Services() {
  return (
    <section id="servicii" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto mb-12 max-w-3xl text-center">
        <p className="mb-3 text-sm font-semibold tracking-wider text-[#2563EB] uppercase">Servicii</p>
        <h2 className="text-4xl font-bold text-[#0F172A] sm:text-5xl">Soluții complete de izolație</h2>
      </div>
